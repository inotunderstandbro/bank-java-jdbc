...
public class BankJavaController {
    ...
    public void start() throws SQLException {
        ...
        while (opcao != 8){
            try{
                ...
                System.out.println("Pressione qualquer tecla e precione ENTER para voltar ao menu.");
                teclado.next();
            }
            opcao = exibirMenu();
        }
    ...
    public int exibirMenu(){
         System.out.println("""
              BYTEBANK - ESCOLHA UMA OPÇÃO:
                  1 - Listar contyas abertas 
                   2 - Abertura de conta
                    3 - Encerramento de conta
                    4 - Consultarsaldo de uma conta
    ...
    public void listarContas(){
        ...
        System.out.println("Pressione qualquer tecla e pressione ENTER para voltar ao menu. ");
        teclado.next();
    }
    ...
    public void encerrarConta(){
        ...
        System.out.println("Aperte qualquer tecla e pressiona ENTER para voltar ao menu!");
        teclado.next();
    }
    public void consultarSaldo(){
        ...
        System.out.println("Aperte qualquer tecla e pressione ENTER para voltar ao menu");
        teclado.next();
    }
    ...
    public void realizarTransferencia(){
        ...
        System.out.println("Aperte qualquer tecla e pressione ENTER para voltare ao menu");
        teclado.next();
